...
- **Task 7** — Stat boxes (Pages, Areas, Sections, Source) in scrollable content area. Re-extract button in header alongside tabs, following Document Type editor pattern.
...
- **Task 5** — Visual nesting improved: increased indentation at area and section levels.
...
- **Undefined** bucket for content outside areas (replaces "Unzoned"). Italic, dimmed styling.
