const o = [
  ...
  // =====================================================================
  {
    ...
    weight: 1100,
    api: () => import("./up-doc-action-BEymQvHg.js"),
  ...
  // =====================================================================
  {
    ...
    element: () => import("./up-doc-collection-action.element-DfZw2tJU.js"),
    weight: 50,
    meta: {
  ...
  // =====================================================================
  {
    ...
    alias: "UpDoc.Modal",
    name: "UpDoc Modal",
    element: () => import("./up-doc-modal.element-BJMD9fud.js")
  },
  {
    type: "modal",
  ...
  },
  {
    ...
    name: "Destination",
    element: () => import("./up-doc-workflow-destination-view.element-BbXMqUw8.js"),
    weight: 300,
    meta: {
      label: "Destination",
  ...
  },
  {
    ...
    element: () => import("./up-doc-workflow-map-view.element-CjfDZJkV.js"),
    weight: 100,
    meta: {
      label: "Map",
      pathname: "map",
