import { b as P, d as G, o as R } from "./workflow.service-DSRz0gSB.js";
...
T = async function() {
  ...
  try {
    ...
    if (E(this, b, await t.getLatestToken()), this._config = await P(d(this, g), d(this, b)), !this._config) {
      this._error = `Workflow "${d(this, g)}" not found`;
      return;
    }
    this._extraction = await G(d(this, g), d(this, b));
  } catch (t) {
...
B = function() {
  ...
  for (let r = 0; r < this._config.map.mappings.length; r++) {
    ...
    if (!v) continue;
    const l = F(v, t) ?? "unmapped", m = e.find((N) => N.id === l)?.label ?? "Unmapped", f = v.blockKey, k = f ? I(f, t) : void 0, w = f ? `${l}:${f}` : l;
    i.has(w) || i.set(w, {
      tabId: l,
      tabLabel: m,
      blockKey: f ?? void 0,
...
//# sourceMappingURL=up-doc-workflow-map-view.element-BATTFFzk.js.map
