import { b as M, d as D, n as S } from "./workflow.service-T0TEyrPt.js";
import { html as l, nothing as _, css as T, state as d, customElement as U } from "@umbraco-cms/backoffice/external/lit";
...
var G = Object.defineProperty, A = Object.getOwnPropertyDescriptor, y = (t) => {
  ...
  for (var o = a > 1 ? void 0 : a ? A(e, i) : e, h = t.length - 1, g; h >= 0; h--)
    (g = t[h]) && (o = (a ? g(e, i, o) : g(o)) || o);
  return a && o && G(e, i, o), o;
}, b = (t, e, i) => e.has(t) || y("Cannot " + i), s = (t, e, i) => (b(t, e, "read from private field"), i ? i.call(t) : e.get(t)), m = (t, e, i) => e.has(t) ? y("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), v = (t, e, i, a) => (b(t, e, "write to private field"), e.set(t, i), i), c = (t, e, i) => (b(t, e, "access private method"), i), u, p, n, x, w, k, $, z, C, E;
...
C = function(t, e) {
  return l`
    ...
    (i) => l`
							...
							${i.transforms?.length ? l`<span class="transform-badge">${i.transforms.map((a) => a.type).join(", ")}</span>` : _}
						`
  )}
				</uui-table-cell>
...
//# sourceMappingURL=up-doc-workflow-map-view.element-CF6V1Rwk.js.map
