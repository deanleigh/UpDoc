import { html as l, nothing as d, css as D, state as c, customElement as S } from "@umbraco-cms/backoffice/external/lit";
...
var k = Object.defineProperty, F = Object.getOwnPropertyDescriptor, m = (t) => {
  throw TypeError(t);
}, n = (t, i, e, u) => {
  for (var o = u > 1 ? void 0 : u ? F(i, e) : i, p = t.length - 1, h; p >= 0; p--)
    (h = t[p]) && (o = (u ? h(i, e, o) : h(o)) || o);
  return u && o && k(i, e, o), o;
}, N = (t, i, e) => i.has(t) || m("Cannot " + e), q = (t, i, e) => i.has(t) ? m("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(t) : i.set(t, e), s = (t, i, e) => (N(t, i, "access private method"), e), r, _, g, v, y, f, b, x, T, w, C, E, $, U;
...
v = async function(t) {
  ...
  try {
    const e = await (await this.getContext(M)).getLatestToken(), u = await fetch(
      `/umbraco/management/api/v1/createfrompdf/page-properties?mediaKey=${t}`,
      {
        method: "GET",
        headers: {
...
y = async function(t, i) {
  try {
    const e = await fetch(
      `/umbraco/management/api/v1/createfrompdf/extract-markdown?mediaKey=${t}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
a = n([
  S("create-from-pdf-modal")
], a);
const O = a;
export {
  a as CreateFromPdfModalElement,
  O as default
};
//# sourceMappingURL=create-from-pdf-modal.element-D_v6KbQ-.js.map
